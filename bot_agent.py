...
goal_object_position = {'x': -3.503, 'y': 1.506, 'z': 0.001}
# Floor lamp position is {'x': -0.369, 'y': 0.026053369, 'z': 4.992}, rotation: {'x': 0.0, 'y': 59.9998856, 'z': 0.0}
# goal_object_position = {'x': -0.369, 'y': 0.026053369, 'z': 4.992}
...
final_pos = get_goal_position(goal_object_position, reachable_positions)
...
cv2.imwrite("FP227_goal_TV.png", current_image)
